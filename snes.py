...
while True:
    ...
    if Keys[pygame.K_x]: screen.blit(crosshair, (197, 103))
    if Keys[pygame.K_y]: screen.blit(crosshair, (173, 123))
    if Keys[pygame.K_a]: screen.blit(crosshair, (221, 122))
    if Keys[pygame.K_b]: screen.blit(crosshair, (196, 142))

    if Keys[pygame.K_u]: screen.blit(crosshair, (50, 68))
    if Keys[pygame.K_i]: screen.blit(crosshair, (196, 68))
    if Keys[pygame.K_j]: screen.blit(crosshair, (100, 130))
    if Keys[pygame.K_k]: screen.blit(crosshair, (128, 130))
